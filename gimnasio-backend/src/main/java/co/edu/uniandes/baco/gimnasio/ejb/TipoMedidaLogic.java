...
public class TipoMedidaLogic extends BaseLogic<TipoMedidaEntity> {
    ...
    Search<TipoMedidaEntity, MaquinaEntity> connMaquina;
    ...
    @Inject
    public TipoMedidaLogic(BasePersistence<TipoMedidaEntity> persistence) {
        super(persistence);
        ...
        this.connMaquina = new Search<>(persistence, TipoMedidaEntity::getMaquinas, MaquinaEntity.class);
    }
    ...
    public MaquinaEntity findMaquina(Long id, Long idMaquina) throws BusinessLogicException {
        return connMaquina.find(id, idMaquina);
    }
}
