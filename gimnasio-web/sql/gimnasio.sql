...
INSERT INTO EJERCICIOENTITY (DESCRIPCION,EXPLICACION,TIPO) VALUES ('Mountain Climbers','un ejercicio que involucra los músculos de la cintura y que nos permiten elevar las piernas a la hora de saltar, golpear un balón o soltar una patada.','AEROBICOS');
INSERT INTO EJERCICIOENTITY (DESCRIPCION,EXPLICACION,TIPO) VALUES ('Abdominales en barra con los brazos sujetos',' hacer los abdominales de esta forma colgamos todo nuestro cuerpo con un único punto de sujeción, los brazos que están agarrados de la barra. Así, todo el cuerpo queda en suspensión, siendo la pared abdominal la que debe de soportar y equilibrar todo nuestro cuerpo. ','AEROBICOS');
INSERT INTO EJERCICIOENTITY (DESCRIPCION,EXPLICACION,TIPO) VALUES ('Remo hhorizontal con mancuerna','Para empezar, hay que posicionarse, tomando una mancuerna con la mano izquierda o derecha, y apoyando la palma de la mano contraria, al igual que la rodilla sobre el banco. La espalda debe permanecer fija y el brazo con la mancuerna extendido hacia abajo, al costado del cuerpo.
